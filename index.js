...
Rewrite this cloudstream plugin to work on stremio convert it to addon for stremio use stremio addon sdk to know codes structures and optimize code to deploy on vercel the original code have all things you want url and how to scrap

Edit
I'll help you convert this CloudStream plugin to a Stremio addon. Let me create a complete Stremio addon using the Stremio addon SDK that can be deployed on Vercel.


Stremio VegaMovies Addon
Code 
Now let me create the package.json and Vercel configuration files:
...
README.md
Document 
I've successfully converted your CloudStream plugin into a complete Stremio addon! Here's what I've created:

Key Features of the Conversion:
Complete Stremio Addon Structure:
Proper manifest configuration with all required fields
Support for movies and TV series
Multiple catalogs for different providers
Three Provider Support:
VegaMovies (main provider)
LuxMovies
RogMovies
Smart URL Management:
Fetches dynamic URLs from GitHub repository
Falls back to hardcoded URLs if fetch fails
Implements caching to reduce API calls
Comprehensive Scraping:
Handles different website structures for each provider
Extracts movie and series information
Supports episode-by-episode streaming for series
Enhanced Metadata:
Integrates with Cinemeta for IMDB data
Provides rich metadata including cast, ratings, descriptions
Proper poster and background images
...
Your addon URL will be: https://your-deployment.vercel.app/manifest.json
Add to Stremio by pasting the manifest URL
Key Differences from Original:
Stremio SDK Structure: Uses proper addon builder pattern
HTTP-based: All scraping done via HTTP requests instead of Android app context
Stateless: Designed for serverless deployment
Error Handling: Comprehensive error handling for network issues
Caching: Implements smart caching for better performance
The addon will provide the same functionality as your original CloudStream plugin but optimized for Stremio's architecture and Vercel's serverless environment.
